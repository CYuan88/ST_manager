...
<!-- 	</script> -->
  ...
  <body style="background:#FAF0E6;">
    ...
    <div style="background:#D3D3D3;width:960;height:300;position:absolute;left:0;top:150;visibility:visible;margin:auto auto auto 200px;">
          ...
          <!--  用户登录div -->
          <div style="background:#D3D3D3;width:400;height:212;position:absolute;left:550;top:40;visibility:visible">
          <b><font size="6" face="楷体">学生登录</font></b><br><br><br>
          <form action="login.action" method="post">
            <font size="5" face="楷体" >用户名：</font><input type="text" class="in" name="userName" style="margin-left:12px;"><br><br>
          <font size="5" face="楷体" >&nbsp;密码：</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" class="in" name="userPwd" ><br><br>
        <label id="infoCode"></label><br>
          <input type="submit" value="登录"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="register.jsp">注册</a>&nbsp;
          <a href="Tlogin.jsp">教师登录</a>
         <form>
